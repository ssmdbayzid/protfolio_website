...
<h3 className=" before:content-['My-Skills'] before:absolute before:-top-2 before:left-[30%]  md:before:left-[38%] before:text-[60px]   before:font-extrabold before:text-[#5c6066]/20 before:-z-10  font-bold  text-5xl hover:bg-transparent text-white/70 text-center relative">
